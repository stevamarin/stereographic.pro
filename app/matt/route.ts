...
export async function GET(req: NextRequest) {
  ...
  const raw = readFileSync(join(process.cwd(), "public/matt/index.html"), "utf-8")
...
export async function POST(req: NextRequest) {
  ...
  res.cookies.set(COOKIE, PASSWORD, { httpOnly: true, sameSite: "lax", path: "/matt" })
  return res
}
